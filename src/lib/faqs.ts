...
export const WEDDING_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Both. Guests can upload video from their camera roll or record on the spot — clips recorded in the page stop at one minute, and any single file can be up to 300MB.",
  },
];
...
export const BIRTHDAY_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Yes — the singing, the candles, the speech that went on too long. Guests can upload clips from their camera roll or record one right in the page (those stop at a minute). Any single file can be up to 300MB.",
  },
  {
...
export const GENERAL_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Each file can be up to 300MB — plenty for photos and short videos. Videos recorded in the page itself stop at one minute.",
  },
  {
