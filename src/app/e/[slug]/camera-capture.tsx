        ...
        <div className="grid grid-cols-3 items-center">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="rounded-full btn-grad px-5 py-2 text-sm font-bold text-white disabled:opacity-40"
            >
          ...
          <div className="flex items-center justify-between gap-3 p-5">
            {review.mode === "new" ? (
              <>
                ...
                <button
                  onClick={keepPending}
                  className="flex-1 rounded-full btn-grad py-3 text-sm font-bold text-white"
                >
                  Keep
                </button>
              </>
