  ...
  return (
    <div className="min-h-screen bg-[#F4ECE3] text-[#2A1B24]">
      ...
      <section className="mx-auto max-w-3xl px-5 pt-16 text-center md:pt-24">
        <p className="text-sm font-medium uppercase tracking-[0.24em] text-[#7A6570]">How it works</p>
        <h1 className="mt-4 text-5xl font-semibold leading-[1.04] tracking-tight text-[#2A1B24] md:text-6xl">
      ...
      <div className="mx-auto max-w-5xl space-y-16 px-5 py-16">
        ...
        <section className="grid items-center gap-10 md:grid-cols-[1fr_auto]">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#B5654A]">Step 1</p>
            <h2 className="mt-2 text-3xl font-semibold tracking-tight">Create your event &amp; get a QR</h2>
            <p className="mt-3 max-w-md text-[#7A6570]">
        ...
        <section className="grid items-center gap-10 md:grid-cols-[auto_1fr]">
          ...
          <div className="order-1 md:order-2">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#B5654A]">Step 2</p>
        ...
        <section className="grid items-center gap-10 md:grid-cols-[1fr_auto]">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[#B5654A]">Step 3</p>
